# Environment and Config Template
...
# Security
ENCRYPTION_KEY=generate_long_random_key
...
Default must be safe: draft only, approval required, high-risk confirmation on, external auto-send off.
